"""Command line interface for FBref tasks."""
...
fbref_app = typer.Typer()


@fbref_app.command(help='Crawl football data.')
def crawl(
...
@fbref_app.command(help='Recrawl errored pages.')
def recrawl(
    competition_name: Annotated[
        str,
        typer.Option(
...
@fbref_app.command(help='Scrape football data.')
def scrape(
    competition_name: Annotated[
        str,
        typer.Option(
...
@fbref_app.command(help='Clean scraped football data.')
def clean(
    competition_name: Annotated[
        str,
        typer.Option(
...
@fbref_app.command(help='Process cleaned football data.')
def process(
    competition_name: Annotated[
        str,
        typer.Option(
